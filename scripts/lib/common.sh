...
nixoa_append_first_install_nix_options() {
  ...
  command_ref+=(
    ...
    --option extra-substituters "$NIXOA_DETERMINATE_SUBSTITUTER $NIXOA_CORE_SUBSTITUTER $NIXOA_XO_SUBSTITUTER"
    --option extra-trusted-public-keys "$NIXOA_DETERMINATE_PUBLIC_KEY $NIXOA_CORE_PUBLIC_KEY $NIXOA_XO_PUBLIC_KEY"
  )
}
