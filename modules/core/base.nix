...
let
  ...
  hostname = getOption systemSettings ["hostname"] "nixoa";
  timezone = getOption systemSettings ["timezone"] "UTC";
  stateVersion = getOption systemSettings ["stateVersion"] "25.11";
in
{
  # ============================================================================
