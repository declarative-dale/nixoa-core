  ...
  updateInputScript =
    ...
    pkgs.writeShellApplication {
      ...
      text = ''
              ...
              if [[ -n "$commit_summary" ]] || ${
                if config.updates.monitoring.notifyOnSuccess then "true" else "false"
              }; then
...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    systemd.services."xoa-nixpkgs-update" = {
    ...
    systemd.timers."xoa-nixpkgs-update" = {
